...
public class PreferencesManager {
	 ...
	 * @param soundEffectsEnabled Boolean whether the sound setting is enabled
	 */
     ...
     * @param musicEnabled Boolean whether the sound setting is enabled
     */
     ...
     * @param volume Float of which the volume is set at
     */
    ...
    public HashMap<String,Integer> getHighScore(){
    	...
    	for(int x = 0; x < 3; x++){
    		highScoreList.put(HIGH_SCORE_LIST[x], getPreferences().getInteger(HIGH_SCORE_LIST[x],1));
    	}
    	return highScoreList;
    }
    
    /**
     * Adds a highscore, the highscore is checked to see whether it can be classified in the top 3
     * @param score Integer of the high score to be added
     */
