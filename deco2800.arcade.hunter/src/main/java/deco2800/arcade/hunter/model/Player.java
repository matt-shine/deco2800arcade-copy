...
public class Player extends Entity {
	...
	/**
	 * Sets the jump playerVelocity
	 * 
	 * @param jumpVelocity
	 *            Float value of what the jump playerVelocity will be set to
	 */
	...
	public void update(float delta) {
		...
		score += 1;    //Bad idea, faster computers will give a higher score per second. TODO
	}
