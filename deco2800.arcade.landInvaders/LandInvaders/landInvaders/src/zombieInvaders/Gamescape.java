...
public class Gamescape extends JPanel implements Stats, Runnable {
	 private Dimension d;
...
/*	    private final String expl = "../spacepix/explosion.png";
	    ...
	    private String gameMsg = "Game Over";
...
/*	        ImageIcon alienImage = new ImageIcon(this.getClass().getResource(alienpix));

	        for (int i=0; i < 4; i++) {
	            for (int j=0; j < 6; j++) {
	                Alien alien = new Alien(alienX + 18*j, alienY + 18*i);
	                alien.setImage(alienImage.getImage());
	                aliens.add(alien);
	            }
	        }*/
...
/*
	    ...
	    public void gameOver()
	    {
	        ...
	        g.setColor(Color.white);
	        g.setFont(small);
	        g.drawString(gameMsg, (BOARD_WIDTH - metr.stringWidth(gameMsg))/2, 
	            BOARD_WIDTH/2);
	    }
