...
public class stageClear extends JFrame{
	...
	public stageClear(Invaders invaders, int score){
		...
		next.setIcon(new ImageIcon(((new ImageIcon(this.getClass().getResource("/image/Button9.png")))
	...
	public class mouse1 implements MouseListener {
		...
		public void mouseEntered(MouseEvent evt) {
			...
			next.setIcon(new ImageIcon(
					((new ImageIcon(this.getClass().getResource("/image/Button10.png"))).getImage())
		...
		public void mouseExited(MouseEvent e) {
			next.setIcon(new ImageIcon(
					((new ImageIcon(this.getClass().getResource("/image/Button9.png"))).getImage())
					.getScaledInstance(200, 50,
							java.awt.Image.SCALE_SMOOTH)));
