...
public class SettingsScreen implements Screen {
	...
	private void initialize() {
		...
		p1AvatarTexRegion = new TextureRegion(
				new Texture(Gdx.files.internal("angel.png")), 0, 0, 256, 256);
		p2AvatarTexRegion = new TextureRegion(
				new Texture(Gdx.files.internal("angel.png")), 0, 0, 256, 256);
	...
	private void createPlayerPanel(Table panel,TextField[] playerDetails,
		...
		panel.row();
		panel.add(playerDetails[0]).padBottom(70).expandX().colspan(3).width(40);
		panel.row();
