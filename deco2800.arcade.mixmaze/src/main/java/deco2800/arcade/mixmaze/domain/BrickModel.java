...
class BrickModel extends ItemModel {
	 ...
	 */
	private static final IllegalArgumentException NUM_OUT_OF_RANGE = new IllegalArgumentException(
			"number must result in an amount no less than 0 and no more than max bricks");
	 ...
	 * 
	 * @param number
	 *            the number of bricks to set
	 * @throws IllegalArgumentException
	 *             If <code>number</code> is negative or greater than
	 *             <code>maxBricks</code>.
	 */
	 ...
	 * 
	 * @param number
	 *            the number of bricks to add
	 * @throws IllegalArgumentException
	 *             If the amount after the addition will be negative or greater
	 *             than <code>maxBricks</code>.
	 */
	 ...
	 * 
	 * @param number
	 *            amount of bricks to be removed. This must be a positive
	 *            number.
	 * @throws IllegalArgumentException
	 *             If the amount after the deletion is negative.
	 */
	...
	/**
	 * Merges the bricks in <code>brick</code> into this brick as many as
	 * possible.
	 * 
	 * @param brick
	 *            the brick to merge from
	 */
