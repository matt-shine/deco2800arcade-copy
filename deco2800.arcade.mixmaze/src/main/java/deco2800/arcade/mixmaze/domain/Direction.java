...
public class Direction {
	...
	/**
	 * Not a direction exception. This exception should be thrown when an
	 * integer is not one of <code>WEST</code>, <code>NORTH</code>,
	 * <code>EAST</code>, or <code>SOUTH</code>.
	 */
	static final IllegalArgumentException NOT_A_DIRECTION = new IllegalArgumentException(
	 ...
	 * @throws NOT_A_DIRECTION
	 *             if the direction is not one of <code>WEST</code>,
	 *             <code>NORTH</code>, <code>EAST</code> or <code>SOUTH</code>.
	 */
	static boolean isDirection(int direction) {
		return isWest(direction) || isNorth(direction) || isEast(direction)
				|| isSouth(direction);
	}
	...
	static int getPolarDirection(int direction) {
		if (!isDirection(direction)) {
			...
			return isPositiveDirection(direction) ? (direction - 2)
					: (direction + 2);
		}
	}
	 ...
	 * @param direction
	 *            the direction
	 * @return true if the direction is <code>WEST</code> or <code>EAST</code>,
	 *         false otherwise
	 */
	 ...
	 * @param direction
	 *            the direction
	 * @return true if the direction is <code>NORTH</code> or <code>SOUTH</code>
	 *         , false otherwise
	 */
	...
	/**
	 * Checks if <code>direction</code> is positive. Positive directions are
	 * <code>SOUTH</code> and <code>EAST</code>.
	 * 
	 * @param direction
	 *            the direction
	...
	/**
	 * Checks if <code>direction</code> is negative. Positive directions are
	 * <code>NORTH</code> and <code>WEST</code>.
	 * 
	 * @param direction
	 *            the direction
