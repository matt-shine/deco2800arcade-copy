...
public interface IMixMazeModel {
	 ...
	 * @return <code>TileModel</code> at position
	 * (<code>x</code>, <code>y</code>).
	 * @throws IllegalArgumentException if the specified position is
	 * invalid.
	 */
	 ...
	 * turns the player to that direction if not already facing it.
	 *
	 * @param id		the player id
	 * @param direction	the movement direction
	 * @throws IllegalStateException if the game has not started.
	 * @throws IllegalArgumentException if the player of the specified
	 * <code>id</code> does not exist, or <code>direction</code> is invalid.
	 */
	 ...
	 * <p>
	 * This method only spawns items every
	 * <code>10 / getMaxItemCount()</code> seconds.
	 */
	void spawnItems();
}
