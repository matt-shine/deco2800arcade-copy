...
public class DirectionTest {
	...
	public void getPolarDirection() {
		assertEquals(Direction.WEST,
				Direction.getPolarDirection(Direction.EAST));
		assertEquals(Direction.NORTH,
				Direction.getPolarDirection(Direction.SOUTH));
		assertEquals(Direction.EAST,
				Direction.getPolarDirection(Direction.WEST));
		assertEquals(Direction.SOUTH,
				Direction.getPolarDirection(Direction.NORTH));
	}
