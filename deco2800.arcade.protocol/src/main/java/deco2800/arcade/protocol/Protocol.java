...
import deco2800.arcade.model.PlayerPrivacyGlob;
...
public class Protocol {
	...
	public static void register(Kryo kryo) {
		...
		kryo.register(FriendsUpdateRequest.class);
		kryo.register(FriendInvitesUpdateRequest.class);
		kryo.register(Games.class);
		kryo.register(PlayerPrivacyGlob.class);
