...
public class TestHighscoreDatabase {
	...
	public void testGetUserRanking() throws DatabaseException, SQLException {
	        // Commented out by Matthew Henry
	        // I can't actually see where this ranking is being set in the
	        // tests and it's returning -1 instead of 3 and making the build
	        // fail. I think it might have something to do with your other
