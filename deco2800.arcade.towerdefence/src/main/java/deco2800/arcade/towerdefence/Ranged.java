...
/**
 * The interface for GridObjects that can shoot projectiles at a position (probably at another GridObject).
 * @author hadronn
 *
 */
public interface Ranged {
	...
	public void shoot();
	//Returns the maximum distance a GridObject can be from another GridObject in order to fire at it.
	public float range();
