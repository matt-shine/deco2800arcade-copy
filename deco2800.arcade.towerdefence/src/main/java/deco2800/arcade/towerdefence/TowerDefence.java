...
public class TowerDefence extends GameClient {
	Screen splashScreen;
	public Screen menuScreen, loreScreen, gameScreen, creditsScreen, optionsScreen;
	...
	// Call this when your own user pauses, so you can pop up a pause menu and pause your game at once
