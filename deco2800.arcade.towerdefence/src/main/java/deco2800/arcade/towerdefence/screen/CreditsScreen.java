...
public class CreditsScreen implements Screen{
	...
	public void resize(int width, int height) {
		...
		words = new Label("", new Label.LabelStyle(new BitmapFont(),
				WHITE));
		words.setWrap(true);
		words.setText("Daniel Kalb - Team lead, comms, class design, feature integration, ensuring roles, code." +
		"\nZerong (Tony) Wang - Game design lead, scribe, gdxlib game mechanics and design." + 
				"\nMichael Ponticello - Code lead, story & theme, SQL queries, gdxlib physics and engine stuff." + 
		"\nAndrew McInnes - Art lead, conceptual art, sprite assets, visual design, comment QA." +
				"\nZach Tuddenham - GUI lead, gdxlib gui, ui design, layout.");
