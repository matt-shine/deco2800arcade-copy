...
public class DoodadList {
    ...
    private static DoodadInfo[] doodads =
            new DoodadInfo[] {
                    ...
                    //210: Dog 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.GUARD, 0, DIRS.RIGHT, true),

                    //211: Dog 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.GUARD, 0, DIRS.UP, true),

                    //212: Dog 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.GUARD, 0, DIRS.LEFT, true),

                    //213: Dog 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.GUARD, 0, DIRS.DOWN, true),
                    ...
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.RIGHT, false),

                    //217: Mutant 1 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.UP, false),

                    //218: Mutant 1 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.LEFT, false),

                    //219: Mutant 1 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.DOWN, false),

                    //220: Mutant 1 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.RIGHT, true),

                    //221: Mutant 1 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.UP, true),

                    //222: Mutant 1 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.LEFT, true),

                    //223: Mutant 1 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 1, EnemyType.MUTANT, 0, DIRS.DOWN, true),
                    ...
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.RIGHT, false),

                    //235: Mutant 3 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.UP, false),

                    //236: Mutant 3 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.LEFT, false),

                    //237: Mutant 3 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.DOWN, false),

                    //238: Mutant 3 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.RIGHT, true),

                    //239: Mutant 3 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.UP, true),

                    //240: Mutant 3 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.LEFT, true),

                    //241: Mutant 3 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 3, EnemyType.MUTANT, 0, DIRS.DOWN, true),
                    ...
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.RIGHT, false),

                    //253: Mutant 4 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.UP, false),

                    //254: Mutant 4 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.LEFT, false),

                    //255: Mutant 4 (Standing)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.DOWN, false),

                    //256: Mutant 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.RIGHT, true),

                    //257: Mutant 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.UP, true),

                    //258: Mutant 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.LEFT, true),

                    //259: Mutant 4 (Moving)
                    new DoodadInfo(true, "penguin", 0, 0, 0, 4, EnemyType.MUTANT, 0, DIRS.DOWN, true),
